// https://api.weatherapi.com/v1/current.json?key=8ae7d154679e4ff1baa181405241009&q=Mumbai&aqi=no
...
const fetchResults = async (targetLocation) => {
  let url = `https://api.weatherapi.com/v1/current.json?key=8ae7d154679e4ff1baa181405241009&q=${targetLocation}&aqi=no`;
